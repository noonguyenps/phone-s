...
import project.phoneshop.mservice.models.HttpResponse;
import project.phoneshop.mservice.models.PaymentRequest;
import project.phoneshop.mservice.models.PaymentResponse;
import project.phoneshop.mservice.enums.*;
import project.phoneshop.mservice.shared.constants.Parameter;
import project.phoneshop.mservice.shared.exception.MoMoException;
import project.phoneshop.mservice.config.Environment;
import project.phoneshop.mservice.shared.utils.Encoder;
...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public static PaymentResponse process(Environment env, String orderId, String requestId, String amount, String orderInfo, String returnURL, String notifyURL, String extraData, project.phoneshop.mservice.enums.RequestType requestType, Boolean autoCapture) throws Exception {
        try {
    ...
    public PaymentResponse execute(PaymentRequest request) throws MoMoException {
        try {
            ...
            System.out.println(captureMoMoResponse.getPayUrl());
...
//            LogUtils.info("[PaymentMoMoResponse] rawData: " + responserawData);
    ...
    public PaymentRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo,
                                                       String returnUrl, String notifyUrl, String extraData, project.phoneshop.mservice.enums.RequestType requestType, Boolean autoCapture) {
